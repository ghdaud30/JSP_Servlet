...
<body>
	...
	%>
	<ul>
		<li>Integer 객체 : <%= (pInteger == null) ? "No Value" : pInteger %></li>
		<li>String 객체 : <%= (pString == null) ? "No Value" : pString %></li>
		<li>Person 객체 : <%= (pPerson == null) ? "No Value" : ((Person)pPerson).getName() %></li>
	</ul>
</body>
</html>